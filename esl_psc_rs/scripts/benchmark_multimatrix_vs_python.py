...
def main():
    ...
    p.add_argument("--species-groups-file", default="test_data/photosynthesis/photo_multi_species_groups.txt")
    p.add_argument("--alignments-dir", default="test_data/photosynthesis/alignments")
    p.add_argument("--prediction-alignments-dir", default="test_data/photosynthesis/alignments")
    p.add_argument("--species-pheno-path", default="test_data/photosynthesis/photo_species_phenotypes.txt")
